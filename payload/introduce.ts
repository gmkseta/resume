...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    '회사에 gitflow, DevOps, lint, 사내 wiki, react 도입을 제안하고 실행했습니다. 매주 회의에서 건전한 기술적인 토론을 통해 설득하기도 하고 설득 당하기도 하며 여러 기술적인 결정에 기여했습니다.',
    '스타트업 고객사들과 프로젝트를 진행하면서 개발 지식이 부족한 고객사와의 커뮤니케이션이 익숙해졌습니다.',
